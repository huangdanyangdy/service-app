<template>
	<view >
		<uni-nav-bar left-icon="back" left-text="返回" right-text="刷新" title="处理中工单" @clickLeft="doBack"
		...
		<view class="search_wrap" v-if="list2[0]">
			...
			<view class="search_list"  @click="seeList(item.orderId)" v-for="item in list2" :key="item.index">
				...
				<view class="space-between pb-2">
					...
					<view class="sever_status" >处理中</view>
				</view>
...
<script>
	...
	import {getDealingMsg} from "@/api/data.js"
	export default {
